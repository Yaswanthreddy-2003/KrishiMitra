                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div className="flex-1 space-y-2.5">
                                    <div className={`inline-block text-xs font-bold px-2.5 py-1 rounded-full ${soilHealth.bgColor} ${soilHealth.textColor}`}>
                                        {soilHealth.label} Soil Condition
                                    </div>
                                    <div className="space-y-2">
                                        <NutrientBar label="Nitrogen" score={soilHealth.breakdown.nScore} />
                                        <NutrientBar label="Phosphorous" score={soilHealth.breakdown.pScore} />
                                        <NutrientBar label="Potassium" score={soilHealth.breakdown.kScore} />
                                        <NutrientBar label="pH" score={soilHealth.breakdown.phScore} />
                                    </div>
                                </div>
                            </div>
                            <p className="text-xs text-gray-400 mt-3">
                                Scores based on standard Indian agricultural optimal ranges (ICAR).
                            </p>
                        </div>
                    )}
